...
from procesamientos.services.trabajador_generacion_nufri import (
    WorkerLockNufri,
    WorkerLockNufriError,
    procesar_generacion_nufri,
    reclamar_siguiente_generacion_nufri,
)


class Command(BaseCommand):
    help = "Procesa generaciones pendientes de NUFRI."
    ...
    def handle(self, *args, **options):
        ...
        try:
            with WorkerLockNufri():
                self.stdout.write(
                    self.style.SUCCESS(
                        "Trabajador Nufri iniciado."
                    )
                )
                while True:
                    generacion = (
                    ...
                    procesar_generacion_nufri(generacion)
                    ...
                    if once:
                        return
        except WorkerLockNufriError as error:
