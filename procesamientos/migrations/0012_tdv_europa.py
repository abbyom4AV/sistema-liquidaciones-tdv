# Generated by Django 5.2.16 on 2026-08-12 18:00
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("procesamientos", "0011_glamour_destino_ui"),
        migrations.swappable_dependency(settings.AUTH_USER_MODEL),
    ]

    operations = [
        migrations.CreateModel(
            name="ProcesamientoTdvEuropa",
            fields=[
                (
                    "id",
                    models.UUIDField(
                ...
                (
                    ...
                    models.FileField(
                        upload_to=(
                            ...
                            .ruta_archivo_despachos_tdv_europa
                        ),
                    ),
                ),
                (
                    ...
                    models.FileField(
                        upload_to=(
                            procesamientos.models
                            .ruta_archivo_liquidacion_tdv_europa
                        ),
                    ),
                ),
                (
                    ...
                    models.FileField(
                        upload_to=(
                            procesamientos.models
                            .ruta_archivo_cliente_tdv_europa
                        ),
                    ),
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        ...
                        upload_to=(
                            procesamientos.models
                            .ruta_archivo_resultado_generacion_tdv_europa
                        ),
                    ),
                ),
                (
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="procesamientos.procesamientotdveuropa",
                    ),
                ),
                (
                    "solicitado_por",
        ...
        migrations.AddConstraint(
            model_name="generaciontdveuropa",
